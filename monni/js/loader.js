(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_5cbec2fd0461262bef3d0f13")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '5ca9d7f87d913a66ea256100';
_mrmcp['creative_id'] = '5cbec2fd0461262bef3d0f13';
...
_mrmcp['type'] = 'smart';
_mrmcp['title'] = '温度计模拟操练';
_mrmcp['build_number'] = parseInt('1451');
_mrmcp['publish_time'] = '4/28/2019 11:34:03 PM';
_mrmcp['last_modified'] = '';
_mrmcp['track_bot'] = 'http://cdn.mugeda.com/media/pages/track/track_20131030.html';
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.14.51';
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        var resPath = jsPath;
            ...
            loadRes(0, resPath + "mugeda_smart_renderer_dragger" + version + ".js", [0], 1);
        
            loadRes(0, resPath + "mugeda_smart_renderer_inputbox" + version + ".js", [0], 2);
        
        loadRes(0, resPath + "mugeda_utils" + version + ".js", [0]);
        loadRes(1, jsPath + that.crid + ".js?publishTime=1556465643106", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1556465643106" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
    ...
    if(_mrmcp['render_mode']!='embedded'&&_mrmcp['render_mode']!='inline'){
        ...
        document.body.style.backgroundColor='rgba(0, 150, 135, 0.32)';
