(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_5cad3bb97d913a6ce1042a4f")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '5ca2d457cec5894faf69c467';
_mrmcp['creative_id'] = '5cad3bb97d913a6ce1042a4f';
...
_mrmcp['type'] = 'smart';
_mrmcp['title'] = '答题闯关1';
_mrmcp['build_number'] = parseInt('1447');
_mrmcp['publish_time'] = '4/11/2019 9:21:02 AM';
_mrmcp['last_modified'] = '';
_mrmcp['track_bot'] = 'http://cdn.mugeda.com/media/pages/track/track_20131030.html';
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.14.47';
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        ...
        loadRes(1, jsPath + that.crid + ".js?publishTime=1554945662705", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1554945662705" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
